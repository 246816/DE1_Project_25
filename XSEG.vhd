...
architecture Behavioral of XSEG is
    ...
    signal sig_input_number : integer range 0 to 200;

    signal sig_segment_1_show : std_logic_vector(6 downto 0);
    signal sig_segment_1_number : integer range 0 to 9;

    signal sig_segment_2_show : std_logic_vector(6 downto 0);
    signal sig_segment_2_number : integer range 0 to 9;
    
    signal sig_segment_3_show : std_logic_vector(6 downto 0);
    ...
    begin
        ...
        if clk'event and clk = '1' then
            ...
            if(rst = '1') then
                ...
                sig_segment_1_show <= (others => "1111111");
                sig_segment_2_show <= (others => "1111111");
                sig_segment_3_show <= (others => "1111111");
            ...
            case sig_seg_number_switcher is
                ...
                when one => 
                    ...
                    sig_segment_1_show <= std_logic_vector(to_unsigned(sig_segment_1_number, 7));
                    AN(0) <= '0';
                    sig_seg_number_switcher <= two;

                when two => 
                    sig_segment_2_show <= std_logic_vector(to_unsigned(sig_segment_2_number, 7));
                    AN(1) <= '0';
                    sig_seg_number_switcher <= three;

                when three => 
                    sig_segment_3_show <= std_logic_vector(to_unsigned(sig_segment_3_number, 7));
                    AN(2) <= '0';
